namespace PHBC.Web.Services
{
    ...
    public class SitemapService : SitemapGenerator, ISitemapService
    {
        ...
        protected virtual IReadOnlyCollection<SitemapNode> GetSitemapNodes()
        {
            ...
            nodes.Add(
                new SitemapNode(this.urlHelper.AbsoluteRouteUrl(ControllerRoute.HomeGetIndex))
                {
                    Priority = 1
                });
            nodes.Add(
               new SitemapNode(this.urlHelper.AbsoluteRouteUrl(ControllerRoute.HomeGetAbout))
               {
                   Priority = 2
               });
            nodes.Add(
               new SitemapNode(this.urlHelper.AbsoluteRouteUrl(ControllerRoute.HomeGetContact))
               {
                   Priority = 2
               });
        ...
        {
            return this.urlHelper.AbsoluteRouteUrl(ControllerRoute.HomeGetSitemapXml).TrimEnd('/') + "?index=" + index;
        }
