namespace PHBC.Web
{
    ...
    public static class BundleConfig
    {
        ...
        private static void AddJavaScript(BundleCollection bundles)
        {
            ...
            //Custem
            Bundle appCustemBundle = new ScriptBundle("~/bundles/appcustem")
                .Include("~/Scripts/jquery.unobtrusive-ajax.min.js")
                .Include("~/Scripts/phbc.js")
                .Include("~/Scripts/lib/popup.js")
                .Include("~/Scripts/lib/scripts.js")
                .Include("~/Scripts/PHBC/phbc_message.js")
                .Include("~/Content/Scripts/jquery.datetimepicker.js");
            bundles.Add(appCustemBundle);
        }
    }
}
