namespace PHBC.Web
{
    ...
    public static class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
                name: ControllerRoute.HomeGetIndex,
                url: "");
            routes.MapRoute(
                name: "DanhMuc",
                url: "danhmuccon/{action}/{typeid}/{code}",
                defaults: new { controller = "danhmuccon", action = "Index", typeid = UrlParameter.Optional, code = UrlParameter.Optional });
            routes.MapRoute(
                name: "PHNC",
                url: "phnc/edit/{unitcode}",
                defaults: new { area = "Admin", controller = "phnc", action = "edit", unitcode = UrlParameter.Optional });
        }
    }
}
