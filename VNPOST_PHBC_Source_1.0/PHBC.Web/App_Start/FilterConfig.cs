namespace PHBC.Web
{
    ...
    public static class FilterConfig
    {
        public static void RegisterGlobalFilters(GlobalFilterCollection filters)
        {
            ...
            //AddValidateHeaderAntiForgeryToken(filters);
        ...
        private static void AddValidateHeaderAntiForgeryToken(GlobalFilterCollection filters)
        {
            filters.Add(new ValidateHeaderAntiForgeryTokenAttribute());
        }
